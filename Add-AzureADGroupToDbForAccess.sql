...
-- Declare the variables, the common name has five characters. The full
-- Azure AD name has eight charaters. The name lengths can the altered below.
...
-- *The group must already exist in Azure AD.
SET @dbr = @db  + '-ro';
